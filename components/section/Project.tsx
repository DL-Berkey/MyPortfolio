...
const projectList: ProjectList = [
    ...
    },
    {
        ...
        content: [
            "기존에는 상품 상세이미지를 제작하기 위해 디자인 툴을 사용해야 했지만, 모든 운영자가 디자인 툴에 익숙하지 않았고 제작자에 따라 결과물의 형태가 달라지는 문제가 있었습니다. 이를 개선하기 위해 상품 상세이미지의 구조를 섹션 단위로 정의하고 관리하는 방식을 설계했습니다.",
            "각 섹션은 이미지와 텍스트로 구성되며, 여러 섹션을 조합해 하나의 상세이미지를 생성할 수 있도록 구현했습니다. 이를 통해 디자인 경험이 부족한 사용자도 정해진 구조 안에서 일관된 형태의 상세이미지를 제작할 수 있도록 개선했습니다.",
            "또한 운영 과정에서 발생하는 이미지 수정 작업을 효율화하기 위해 AI 기반 이미지 수정 및 변형 기능을 추가했습니다. 별도의 디자인 툴 없이 운영툴 내에서 생성된 이미지를 수정할 수 있도록 구현했으며, 프로젝트 단위로 작업을 관리하고 사용자가 작업 내용을 저장할 수 있는 버전 관리 기능을 구현해 특정 시점의 작업 상태로 복원할 수 있도록 구성했습니다.",
        ],
        contributions: [
            "상품 상세이미지 제작 과정 분석 및 섹션 기반 데이터 구조 설계",
            "이미지·텍스트 기반 상세이미지 생성 기능 개발",
