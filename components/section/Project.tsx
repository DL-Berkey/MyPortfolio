...
const projectList: ProjectList = [
    {
        title: "캔실장",
        description:
            "(주)주한원의 웹 서비스를 맡아 서비스 오픈 준비부터 신규 기능 개발까지 프론트엔드 전반을 담당했습니다.",
        content: [
            ...
            "서비스가 안정화된 이후에는 서비스의 핵심 비즈니스 흐름을 고려해 입찰 관리 시스템과 상담 관리 시스템을 우선 개발했습니다. 이후 관리자 페이지 실시간 통계와 Telegram Bot 알림 기능을 구현해 운영자가 사용자 요청에 빠르게 대응할 수 있는 환경을 구축했습니다. API 서버는 기존 개발자가 만들어 둔 것을 사용했기 때문에, 각 API가 문서와 같은 값과 상태 코드를 반환하는지 확인하고 실패 응답에 대한 처리를 컴포넌트 단위로 정리했습니다.",
        ...
        contributions: [
            ...
            "API 응답과 상태 코드 검증 및 실패 응답 처리 정리",
        ],
